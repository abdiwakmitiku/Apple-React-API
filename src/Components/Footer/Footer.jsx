...
import "./Footer.css"
import OneSix from "../../assets/Images/icons/16.png"
      ...
      <div class="container">
        ...
        <div class="copyright-wrapper row">
          ...
          <div class="footer-links-terms col-sm-12 order-3 col-lg-6 order-lg-2">
            <ul>
              <li class="px-md-2"><a href="#">Privacy Policy</a></li>
              <li class="px-md-2"><a href="#">Terms of Use</a></li>
              <li class="px-md-2"><a href="#">Sales and Refunds</a></li>
              <li class="px-md-2"><a href="#">Legal</a></li>
              <li class="px-md-2"><a href="#">Site Map</a></li>
            </ul>
          </div>
          <div
            class="footer-country col-sm-12 order-1 col-md-4 order-md-2 text-md-right col-lg-2 order-lg-3"
          >
            <div class="flag-wrapper"><img src={OneSix} /></div>
